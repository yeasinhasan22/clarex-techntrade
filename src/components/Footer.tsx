                      ...
                      <div className="col-lg-4 col-sm-6 d-flex">
                          <div className="footer-widget">
                              ...
                              <div className="footer-contact mb-40">
                                  ...
                                  <a href="mailto:info@clarex.co">info@clarex.co</a><br />
                      ...
                      <div className="col-lg-3 col-sm-6 d-flex justify-content-lg-start justify-content-sm-end">
                          <div className="footer-widget">
                              ...
                              <div className="menu-container">
                                  <ul>
                                      <li><a href="/noc">NOC Services</a></li>
                                      <li><a href="/service2">Infrastructure and Network Services</a></li>
                                      <li><a href="/service3">Quality Assurance</a></li>
                                      <li><a href="/service4">Managed IT Services</a></li>
                                      ...
                                      <li><a href="/service8">ERP Solution</a></li>
                                  </ul>
                              </div>
                          </div>
                      </div>
                          ...
                          <div className="footer-widget">
                              ...
                              <div className="menu-container">
                                  <ul>
                                      ...
                                      <li><a href="/service-details">Service</a></li>
                          ...
                          <div className="footer-widget">
                              ...
                              <div className="menu-container">
                                  <ul>
                                      ...
                                      <li><a href="/contact">Support Policy</a></li>
                              ...
                              <div className="footer-btn-content">
                                  ...
                                  <div className="footer-social">
                                      <ul>
                                          ...
                                          <li><a href="https://www.linkedin.com/"><i className="bx bxl-pinterest-alt"></i></a>
                                          </li>
