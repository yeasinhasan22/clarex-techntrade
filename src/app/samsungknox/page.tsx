...
export const metadata: Metadata = {
  ...
  description:
    "CLAREx Tech & Trade is Bangladesh's only Samsung Knox license reseller. Enterprise MDM, device security, and 16,000+ Knox licenses delivered in the last year.",
};
